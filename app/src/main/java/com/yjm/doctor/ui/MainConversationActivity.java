...
//		inviteMessgeDao = new InviteMessgeDao(this);
	...
	EMClientListener clientListener = new EMClientListener() {
		...
		public void onMigrate2x(boolean success) {
			Toast.makeText(MainConversationActivity.this, "onUpgradeFrom 2.x to 3.x " + (success ? "success" : "fail"), Toast.LENGTH_LONG).show();
			if (success) {
...
//				Toast.makeText(MainActivity.this, "All permissions have been granted", Toast.LENGTH_SHORT).show();
	...
	private void initView() {
		...
		LinearLayout a = (LinearLayout)findViewById(R.id.main_bottom);
...
//	private InviteMessgeDao inviteMessgeDao;
	...
	protected void onResume() {
		...
		// background
		Helper sdkHelper = Helper.getInstance();
			...
			try {
				if (exceptionBuilder == null)
					...
					public void onClick(DialogInterface dialog, int which) {
						...
						isExceptionDialogShow = false;
						finish();
						Intent intent = new Intent(MainConversationActivity.this, LoginActivity.class);
