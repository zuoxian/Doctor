...
public abstract class EaseChatRow extends LinearLayout {
    ...
    public EaseChatRow(Context context, EMMessage message, int position, BaseAdapter adapter) {
        ...
        sharedPreferencesUtil = SharedPreferencesUtil.instance(context);
        initView();
    }
        ...
        if(userAvatarView != null) {
            ...
            if (message.direct() == Direct.SEND) {
                ...
                if(!TextUtils.isEmpty(a)) {
                    try {
                        User my = (User) sharedPreferencesUtil.deSerialization(a);
                        if(null != my && !TextUtils.isEmpty(my.getPicUrl())){
                            EaseUserUtils.setUserAvatar(context, EMClient.getInstance().getCurrentUser(), userAvatarView,my.getPicUrl());
                        }else{
                            EaseUserUtils.setUserAvatar(context, EMClient.getInstance().getCurrentUser(), userAvatarView,"");
                        }

                    }catch (Exception e){
                        Log.i("ChatActivity",e.getMessage());
                    }
                ...
                SharedPreferences sp = sharedPreferencesUtil.getSp(message.getFrom());
                if(!TextUtils.isEmpty(sp.getString("header_url",""))) {
                    EaseUserUtils.setUserAvatar(context, message.getFrom(), userAvatarView, sp.getString("header_url",""));
                }else{
